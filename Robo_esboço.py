...
roboLinha = randint(0, 2)
roboColuna = randint(0, 2)
bateriaLinha = randint(0, 2)
bateriaColuna = randint(0, 2)
...
def iniciar_novo_jogo():
    ...
    roboLinha = randint(0, 2)
    roboColuna = randint(0, 2)
    print(roboLinha + 1, roboColuna + 1)
    tabuleiro_jogoDoRobo[roboLinha][roboColuna] = 'RB'
        
    bateriaLinha = randint(0, 2)
    bateriaColuna = randint(0, 2)
    print(bateriaLinha + 1, bateriaColuna + 1)
    tabuleiro_jogoDoRobo[bateriaLinha][bateriaColuna] = 'BT'
